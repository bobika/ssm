...
<html lang="en">
    ...
    <body class="cm-no-transition cm-1-navbar">
                ...
                <div id="cm-menu-items-wrapper">
                    <div id="cm-menu-scroller">
                        <ul class="cm-menu-items">
                            <li class="active"><a href="alglibrary.jsp" class="sf-house">主页</a></li>
                            <li><a href="#" class="sf-dashboard">机器学习算法</a></li>
                            <li class="cm-submenu">
                                <a class="sf-window-layout">算法文档<span class="caret"></span></a>
                                <ul>
                                    <li><a href="#">简介</a></li>
                                    <li><a href="#">关联规则</a></li>
                                    <li><a href="#">聚类</a></li>
            ...
            <div class="container-fluid">
                <div class="row cm-fix-height">
                    <div class="col-sm-4">
                        <div class="panel panel-default">
                            <div class="panel-body">
                                <img src="assets1/img/sass-less.png" alt="Less support" class="img-responsive">
                                <br>
                    ...
                    <div class="col-sm-4">
                        <div class="panel panel-default">
                            <div class="panel-body">
                                <img src="assets1/img/devices.png" alt="Responsive across devices" class="img-responsive">
                                <br>
                    ...
                    <div class="col-sm-4">
                        <div class="panel panel-default">
                            <div class="panel-body">
                                <img src="assets1/img/components.png" alt="Components" class="img-responsive">
                                <br>
                ...
                <div class="row cm-fix-height">
                    <div class="col-xs-6 col-sm-4 col-md-3 col-lg-2">
                        <a href="dashboard-sales.html" class="panel panel-default thumbnail cm-thumbnail">
                            <div class="panel-body text-center">
                                <span class="svg-48">
                                    <img src="assets1/img/sf/dashboard.svg" alt="dashboard">
                                </span>
                    ...
                    <div class="col-xs-6 col-sm-4 col-md-3 col-lg-2">
                        <a href="notepad.html" class="panel panel-default thumbnail cm-thumbnail">
                            <div class="panel-body text-center">
                                <span class="svg-48">
                                    <img src="assets1/img/sf/notepad.svg" alt="notepad">
                                </span>
                    ...
                    <div class="col-xs-6 col-sm-4 col-md-3 col-lg-2">
                        <a href="components-text.html" class="panel panel-default thumbnail cm-thumbnail">
                            <div class="panel-body text-center">
                                <span class="svg-48">
                                    <img src="assets1/img/sf/brick.svg" alt="brick">
                                </span>
                    ...
                    <div class="col-xs-6 col-sm-4 col-md-3 col-lg-2">
                        <a href="layouts-breadcrumb1.html" class="panel panel-default thumbnail cm-thumbnail">
                            <div class="panel-body text-center">
                                <span class="svg-48">
                                    <img src="assets1/img/sf/window-layout.svg" alt="window-layout">
                                </span>
                    ...
                    <div class="col-xs-6 col-sm-4 col-md-3 col-lg-2">
                        <a href="ico-sf.html" class="panel panel-default thumbnail cm-thumbnail">
                            <div class="panel-body text-center">
                                <span class="svg-48">
                                    <img src="assets1/img/sf/cat.svg" alt="cat">
                                </span>
                    ...
                    <div class="col-xs-6 col-sm-4 col-md-3 col-lg-2">
                        <a href="login.html" class="panel panel-default thumbnail cm-thumbnail">
                            <div class="panel-body text-center">
                                <span class="svg-48">
                                    <img src="assets1/img/sf/lock-open.svg" alt="lock-open">
                                </span>
        ...
        <script src="assets1/js/demo/home.js"></script>
    </body>
</html>